			...
			<div className="section-container relative z-10">
				...
				>
					<motion.div
						...
						className="inline-flex items-center justify-center w-28 h-24 bg-white rounded-full mb-8 shadow-2xl"
					>
						{/* <FaGlobeAmericas className="text-primary text-5xl" /> */}
						<Image
							src="/images/SATGO-LOGOS.png"
							alt="SATGO Logo"
							width={80}
							height={80}
					...
					<h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-shadow">
						<span className="gradient-text text-secondary">SATGO</span> Office
					</h1>
